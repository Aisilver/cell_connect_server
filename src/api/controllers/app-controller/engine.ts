...
import { APP_R_Init_prepareAndCacheCities } from "./initializers/prepare-and-cache-cities.init-func";
import { APP_R_Init_prepareAndCacheAppSettings } from "./initializers/prepare-and-cache-app-settings.init-func";
import { APP_R_Init_prepareAndCacheAppMeetingTypes } from "./initializers/prepare-and-cache-app-meeting-types.init-func";
    ...
    protected initializers: InitializerConfig[] = [
        {
            ...
            priority: 'top',
            initFunc: () => APP_R_Init_prepareAndCacheCities()
        },
...

        {
            ...
            priority: "top",
            initFunc: () => APP_R_Init_prepareAndCacheAppMeetingTypes()
        }
    ];
